...
plot  "resultat_HLLC.txt" u 1:2 w lp ls 1 t 'density: schema HLLC', "resultat_HLL.txt" u 1:2 w lp ls 2 t 'density: schema HLL'

set ylabel "velocity"
set key top left
set output "velocity.pdf"
plot  "resultat_HLLC.txt" u 1:3 w lp ls 1 t 'velocity: schema HLLC', "resultat_HLL.txt" u 1:3 w lp ls 2 t 'velocity: schema HLL'

set ylabel "specific internal energy"
set key top left
set output "energy.pdf"
plot  "resultat_HLLC.txt" u 1:4 w lp ls 1 t 'specific internal energy: schema HLLC', "resultat_HLL.txt" u 1:4 w lp ls 2 t 'specific internal energy: schema HLL'

set ylabel "pressure"
set key top right
set output "pression.pdf"
plot  "resultat_HLLC.txt" u 1:5 w lp ls 1 t 'pression: schema HLLC', "resultat_HLL.txt" u 1:5 w lp ls 2 t 'pression: schema HLL'
