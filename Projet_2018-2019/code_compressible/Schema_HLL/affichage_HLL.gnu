...
plot  "resultat_HLL.txt" u 1:2 w lp ls 1 t 'density'

set output "velocity.pdf"
plot  "resultat_HLL.txt" u 1:3 w lp ls 1 t 'velocity'

set output "energy.pdf"
plot  "resultat_HLL.txt" u 1:4 w lp ls 1 t 'specific internal energy'

set output "pression.pdf"
plot  "resultat_HLL.txt" u 1:5 w lp ls 1 t 'pression'
